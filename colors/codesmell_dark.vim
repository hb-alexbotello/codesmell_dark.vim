...
call s:HL('Typedef', s:colors.dodger_blue, s:colors.none, s:colors.bold)
" ----------------------------------------------------
...
call s:HL('TSVariable', s:colors.bright_green, s:colors.none)
call s:HL('TSParameter', s:colors.yellow, s:colors.none)
call s:HL('TSConstant', s:colors.white, s:colors.none)
